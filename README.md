...
## 5. API de Trabajo Externo

El API de trabajo externo es una API para trabajo, normalmente usada por APIs que quieren trabajar de la mano con Betta para ofrecer una integración completa con nuestro sistema de GESTIONES.

Para saber más [haz clic aquí](./EXTERNAL_WORK_API.md)
